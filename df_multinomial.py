...
def bn_ci_plot(dow_mean_ci, ax=None, rot_xticks=True, **kwargs):
    """
    plots for binomial feature
    ...
    groups = list(dow_mean_ci.index)
    xm = dow_mean_ci.index
    ...
    if ax is None:
        plt.errorbar(xm, ym, yerr=yerr, **kwargs);
    else:
